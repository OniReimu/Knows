# Sub-skills (Knows Orchestrator v1.0+)

Each subdirectory hosts one sub-skill that the Knows orchestrator dispatches to via the typed tuple `(intent_class, required_inputs, requested_artifact)` defined in `../references/dispatch-and-profile.md` §1.
